            ...
            _.initials = {
                ...
                dates: {
                    kz: {
                        ...
                        daysShort: ["Жек", "Дүй", "Сей", "Сәр", "Бей", "Жұ", "Сен"],
                        daysMin: ["Жс", "Дс", "Сн", "Ср", "Бс", "Жм", "сб"],
                        months: ["Қаңтар", "Ақпан", "Мамыр", "Сәуір", "Мамыр", "Маусым", "Шілде", "Тамыз", "Қыркүйек", "Қазан", "Қараша", "Желтоқсан"],
                        monthsShort: ["Қан", "Ақп", "Мамыр", "Сәу", "МАй", "Мау", "Шіл", "Там", "Қыр", "Қаз", "Қар", "Жел"],
                        noEventForToday: "Бүгінгі күнге ешқандай жаңалық жок :)",
                        noEventForThisDay: "Бүгінгі күнге ешқандай жаңалық жок",
                        previousYearText: "Артқы жыл",
                        nextYearText: "Келесі жыл",
                        closeSidebarText: "Сайдбар жабу",
                        closeEventListText: "Ивентті жабу"
                    },
                    en: {
